    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 40-17),
            child: ExpansionTile(
                ...
                title: Text(category, style: AppStyles.headLineStyle3,),
                children: ingredients.map((ingredient) {
                  ...
                  return ListTile(
                    title: Text(ingredient.name, style: AppStyles.textStyle,),
                    trailing: Icon(
                      isSelected
                          ? Icons.check_box
